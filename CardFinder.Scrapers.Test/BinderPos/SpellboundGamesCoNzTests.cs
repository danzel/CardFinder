...
public class SpellboundGamesCoNzTests
{
	...
	public async Task AridMesa()
	{
		...
		var scraper = new BinderPosScraper(NullLogger<BinderPosScraper>.Instance, client.Object, new DefaultConditionParser(), new DefaultTreatmentParser(), BinderPosConfiguration.SpellboundGamesCoNz);
